defmodule PintelierWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PintelierWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PintelierWeb.Gettext, "errors", msg, opts)
    end
  end
